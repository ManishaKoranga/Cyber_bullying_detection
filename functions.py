...
def custom_input_prediction(text):
    ...
    print('after preprocessiong'+text)
    text = [text[0],]
...
custom_input_prediction('men are the ones that are going to push the real change. they are the ones in power, generally. we need their help')
